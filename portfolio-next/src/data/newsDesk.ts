...
// 鈹€鈹€ Events 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export const aiFinanceEvents: EventListing[] = [
  ...
  {
    title: "AI Tinkerers London 鈥?Monthly Builder Meetup",
    date: "Monthly (check website for next session)",
    venue: "Various London venues 鈥?see website",
    price: "Free",
    description:
  ...
  },
  {
    ...
    price: "Registration",
    description:
      "Multi-track technical conference covering machine learning engineering, LLM deployment, inference optimisation, and production ML systems. Expo on May 12鈥?3 is open access.",
    link: "https://mlconference.ai/london/",
    source: "MLcon",
    type: "ML Conference",
  },
  {
    title: "The AI Summit London 鈥?Fringe Events",
    date: "June 8鈥?4, 2026",
  ...
  },
  {
    ...
    date: "October 2026 (dates TBC 鈥?check website)",
    venue: "London",
    price: "Registration",
    description:
      "The 47th Energy Intelligence Forum brings together 500+ delegates from 45+ countries 鈥?private sector, government, and civil society 鈥?to address global energy challenges. The premier annual gathering for energy market professionals, formerly known as Oil & Money.",
...
// 鈹€鈹€ Desks 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€

export const desks: NewsDesk[] = [
  // 鈹€鈹€ Financial Infrastructure 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  {
    id: "finance",
    ...
    feature: {
      label: "Financial Infrastructure",
      title:
        "Stablecoins are settled law 鈥?now FinTech and Big Finance are racing to own the stack.",
      summary:
        "The GENIUS Act resolved regulatory ambiguity. The FDIC proposed rules in April to implement it. And within weeks, Visa, Mastercard, BitGo, SoFi, and the major banks are all positioning for custody, liquidity routing, and compliance infrastructure. The real margin is not in minting stablecoins 鈥?it is in the connective tissue around them.",
      tags: [
    ...
    stories: [
      {
        ...
        date: "April 8, 2026",
        headline:
          "FinTech and Big Finance are fighting to own the stablecoin stack 鈥?and it is not about the coins",
        dek:
        ...
        imageClassName: "object-center",
        paragraphs: [
          "The pattern is becoming clear 鈥?and it accelerated noticeably in the fortnight ending April 8, 2026. Visa and Bridge expanded their cross-border stablecoin settlement capabilities, allowing merchants and financial institutions to settle in USDC and USDT across more than 60 payment corridors. BitGo and SoFi announced a partnership around a modular 'stablecoin stack' infrastructure product covering institutional custody, yield generation on reserves, and compliance-aware routing 鈥?with Mastercard joining as a distribution partner. The UK Financial Conduct Authority simultaneously identified stablecoin payments as a top regulatory priority for 2026, opening a formal consultation on permitted issuers and custodians. In the space of two weeks, every major payment network had taken a structural position. The race to own stablecoin infrastructure had begun, and its competitive logic has little to do with the coins themselves.",
        ...
        packet: {
          ...
          sourceAnchors: [
            {
              label: "PYMNTS 鈥?FinTech and Big Finance fight to own the stablecoin stack",
              url: "https://www.pymnts.com/cryptocurrency/2026/fintech-and-big-finance-fight-to-own-the-stablecoin-stack/",
            },
            {
              label: "FinTech Weekly 鈥?stablecoin infrastructure predictions 2026",
      ...
      },
      {
        ...
        dek:
          "With the FDIC's April 7 proposed rulemaking implementing the GENIUS Act, the United States formally defined payment stablecoins as a new class of instrument 鈥?not securities, not commodities, but a new category of money.",
        image:
        ...
        paragraphs: [
          ...
          "For fintech operators and traditional financial institutions making capital allocation decisions today, the relevant historical analogue is real-time domestic payment rails. In markets where real-time payment infrastructure was built early 鈥?the UK's Faster Payments, India's UPI 鈥?the firms that made infrastructure investments in the first cycle captured structural position that was difficult and expensive to replicate once the market concentrated. Waiting for technology standardisation is rational when the infrastructure build is speculative; it is less rational when regulatory clarity has already defined the target architecture and volume projections suggest a trajectory that makes early capital deployment economically attractive. The GENIUS Act is the regulatory signal that the speculative phase of stablecoin infrastructure has ended.",
        ],
        modelView:
          "Expected payment infrastructure value = (payment volume 脳 net settlement margin 脳 market share) 鈭?compliance cost 鈭?technology investment. As volume grows from 3% to 10% of USD payments, first-mover advantage on infrastructure becomes multiplicative.",
        bottomLine:
          "The GENIUS Act has created the legal foundation for a parallel payment system 鈥?the race to build the infrastructure has already started.",
        packet: {
          audience: defaultAudience,
          briefing:
            "Write a 1300鈥?500 word professional analysis of the GENIUS Act and its April 2026 FDIC rulemaking implementation. Explain what legal clarity means for bank participation, cross-border settlement, and infrastructure investment. Include one quantitative frame on stablecoin payment volume trajectories and close with the strategic implications for fintech operators.",
          ...
          sourceAnchors: [
            ...
            {
              label: "GENIUS Act explained 鈥?State Street Global Advisors",
  ...
  // 鈹€鈹€ AI News 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  {
    id: "ai",
    label: "AI News",
    intro:
      "MCP has crossed 97 million installs in 16 months 鈥?faster than React reached comparable scale. The standard for agent-to-tool connectivity is settled. Meanwhile Anthropic holds 40% of enterprise LLM spend, Claude Code is in production, and every major AI vendor is competing on governance and deployment trust, not just benchmark scores.",
    feature: {
      label: "AI News",
      title:
        "The agent connectivity standard has been decided 鈥?and 97 million installs later, the infrastructure race begins.",
      summary:
        "MCP's adoption curve 鈥?from Anthropic launch in November 2024 to 97 million installs by March 2026, with every major AI vendor now backing it through the Linux Foundation 鈥?marks the end of the fragmented integration era for AI agents. The next competition is not over the protocol. It is over who builds the most valuable managed services on top of it.",
      tags: [
        "MCP standard",
        "agent connectivity",
        "enterprise AI",
    ...
    stories: [
      {
        ...
        date: "April 2, 2026",
        headline:
          "MCP crossed 97 million installs in 16 months 鈥?the agent connectivity standard is settled",
        dek:
        ...
        packet: {
          ...
          sourceAnchors: [
            {
              label: "Model Context Protocol hits 97M installs 鈥?ByteIota",
              url: "https://byteiota.com/model-context-protocol-hits-97m-installs-standard-wins/",
            },
            {
              label: "Anthropic's MCP 鈥?AI Unfiltered",
      ...
      },
      {
        ...
        dek:
          "When one model family controls more enterprise API spend than the incumbent that invented the category, the competitive dynamics of AI have structurally changed 鈥?and the reason is not just benchmarks.",
        image:
      ...
      },
      {
        ...
        dek:
          "Anthropic's terminal-native agent does not just assist developers 鈥?it completes software engineering tasks end to end: cloning repositories, writing tests, fixing CI pipelines, and opening pull requests.",
        image:
        ...
        imageClassName: "object-center",
        paragraphs: [
          "The distinction between an AI coding assistant and an autonomous software agent is not a marketing distinction 鈥?it describes a fundamentally different operational model. An assistant produces suggestions, completions, or snippets for a human to evaluate, modify, and apply. The human remains the actor; the AI is a tool. An agent owns the full execution loop: it reads and understands the repository structure, forms a plan, writes code, runs tests, interprets failures, revises its approach, iterates until a working result is achieved, and presents the outcome. The human may set the objective and review the output, but does not manage the intermediate steps. Claude Code, launched as a standalone product in April 2026, sits firmly in the second category 鈥?and the distinction has direct implications for where and how it creates economic value.",
          "The capability set reflects that design intent. Claude Code can clone repositories, navigate complex multi-file codebases, write and execute test suites, diagnose failing CI pipelines by reading error logs and stack traces, identify the root cause, fix the underlying issue, and open pull requests with descriptive commit messages 鈥?without human intervention at intermediate steps. Integration with GitHub, GitLab, and Jira means it operates natively inside the engineering workflows that organisations already use, without requiring teams to adopt new tooling or change their processes. The MCP integration means it can access external tools 鈥?documentation, monitoring systems, internal APIs 鈥?through the standard protocol that enterprises are now deploying at scale. This is not a prototype; it is designed to operate on production codebases with real consequences.",
          "The relevant benchmark is not conversational fluency but task completion rate on genuinely difficult real-world software engineering problems. Claude Code's 65.3% resolution rate on SWE-bench Verified represents the state of the art on a benchmark that tests resolution of real open-source GitHub issues 鈥?problems that require reading existing code, understanding system context, diagnosing the failure mode, and producing a working fix that passes the existing test suite. The benchmark is deliberately adversarial to shallow pattern-matching approaches; it requires the kind of reasoning about system state and causal relationships that characterises experienced engineering judgment. A 65% resolution rate on that class of problem is commercially material: it means the agent resolves roughly two in three realistic engineering tasks without human intervention.",
          "The commercial implications follow directly from the economics of software engineering effort. Development backlogs at software companies are not capacity-constrained by the availability of senior engineers capable of complex architectural decisions 鈥?they are constrained by the volume of maintenance tasks, bug triage, test coverage improvements, dependency upgrades, and documentation work that consumes developer time without requiring senior judgment. If an autonomous agent handles a meaningful fraction of that backlog reliably 鈥?even 30-40% of incoming issues 鈥?the marginal cost of that work falls toward infrastructure cost rather than salary cost. That does not straightforwardly translate to headcount reduction in most organisations; it translates to a change in how engineering capacity is allocated, with human engineers concentrating on the problems that require human judgment while agents handle the ones that do not.",
          "The organisational change management dimension is significant and often underweighted. Engineering teams that have operated with a human-in-the-loop at every commit will need to develop new practices around agent-generated code 鈥?different review protocols, clear delineation of which task categories are appropriate for autonomous completion, and a different relationship with the test suite as the primary quality gate rather than line-by-line code review. Those organisational adaptations take time, and the teams that develop them earliest will capture the productivity advantages fastest. The technology is available now; the constraint on adoption velocity is process design, not capability.",
          "The governance requirements for enterprise adoption are not optional features 鈥?they are preconditions. When a system can push code to a shared repository autonomously, the audit trail, permission boundary, and review gating infrastructure must be in place before deployment, not added retrospectively when an incident occurs. Specifically: agent actions must be logged with sufficient detail for post-hoc review; permission boundaries must prevent autonomous agents from accessing production systems or credentials without explicit authorisation; review gates must be configurable to require human approval on high-risk operations such as schema changes or security-relevant modifications. Claude Code's integration with existing GitHub and GitLab review workflows provides the structural foundation for these controls, but organisations must configure them deliberately.",
          "The longer-term implication for the software engineering labour market is a question that serious analysis cannot avoid. Autonomous agents that resolve 65% of realistic engineering tasks today, operating on an improvement curve that has consistently improved by 15-20 percentage points annually on SWE-bench class benchmarks, will resolve a materially higher fraction within two to three years. The economic consequence is not uniform across roles: engineers who spend the majority of their time on the maintenance and bug-fix categories of work will face the most direct substitution pressure, while engineers whose primary value lies in system design, stakeholder communication, and novel problem-solving will find their relative scarcity 鈥?and therefore their market value 鈥?increasing. The transition will likely be faster in large software organisations with standardised codebases than in bespoke or safety-critical development environments.",
        ],
        modelView:
          "Expected value of autonomous software agents = (task completion rate 脳 average task value) 鈭?(error rate 脳 error cost) 鈭?governance overhead. At a 65% completion rate on realistic tasks, the first term becomes commercially material.",
        bottomLine:
          "The autonomous software engineering agent has arrived in production 鈥?the remaining question is governance, not capability.",
        packet: {
          audience: defaultAudience,
          briefing:
            "Write a 1300鈥?500 word article on Claude Code as the first production-scale autonomous software agent. Explain the distinction between assistant and agent, the commercial implications for engineering labour economics, and the governance infrastructure required for enterprise adoption. Include one quantitative frame on expected value under realistic completion rates.",
      ...
      },
      {
        ...
        imageClassName: "object-center",
        paragraphs: [
          "Microsoft's Frontier Suite is notable not for its model quality but for where it sits in the enterprise technology stack. Rather than asking organisations to adopt a new standalone AI surface 鈥?a separate application, a new login, a new set of administrative controls 鈥?it folds agentic capability into the productivity, identity, and security systems that enterprise IT departments already manage. Word, Excel, Outlook, Teams, and Copilot Chat gain autonomous agent behaviours without requiring a new procurement decision, a new security review, or a new administrative interface. The AI capability arrives through the systems that organisations already budget for and trust. That distribution advantage is the primary strategic asset, and it is more durable than any benchmark lead.",
          ...
          "The competitive response from Google Workspace and Salesforce 鈥?both of which have embedded AI agent capabilities within their respective installed bases 鈥?suggests that the distribution-plus-governance strategy is being validated across the enterprise software market. The common thread is that the AI products gaining enterprise traction are those that reduce deployment friction by arriving through channels organisations already trust, rather than those that maximise raw model capability at the cost of integration complexity. For independent AI vendors without a comparable installed base, the implication is difficult: competing on capability alone against vendors who combine adequate capability with native enterprise distribution is an increasingly unfavourable position.",
          "The longer-term competitive dynamic will be determined by whether Microsoft can maintain model quality parity through its OpenAI partnership as competing models improve. The distribution moat is real and durable; the capability moat is more contingent. If the gap between Microsoft's model access through OpenAI and the best available alternatives narrows over time, the distribution advantage remains. If enterprises become willing to manage model selection independently 鈥?choosing between providers based on task-specific performance rather than accepting a bundled solution 鈥?the value of the distribution channel decreases. The Frontier Suite is a bet that enterprises will prefer the convenience of a governed, integrated, single-vendor AI solution over the flexibility and potential capability advantages of managing a multi-vendor model portfolio.",
        ],
        modelView:
          "Enterprise AI adoption = productivity gain 鈭?orchestration friction 鈭?governance overhead 鈭?error cost. Bundling agents into existing software reduces two of those penalties immediately.",
        bottomLine:
          "Distribution plus governance is what turns agents from pilots into infrastructure.",
        packet: {
          audience: defaultAudience,
          briefing:
            "Write a 1300鈥?500 word article on Microsoft's Frontier Suite as an enterprise operating model shift. Explain why distribution, identity, and control matter as much as raw model quality. Include one quantitative deployment framework and close with implications for CIOs and software vendors.",
      ...
      },
      {
        ...
        dek:
          "The acquisition signals that agent quality is no longer judged only by fluency 鈥?it is judged by whether organisations can test, document, and govern failure before deployment.",
        image:
        ...
        paragraphs: [
          ...
          "From a mathematical perspective, the case is direct. A system with high average productivity but fat-tailed failure modes can still have negative expected value once deployed into sensitive workflows. Evaluation is the discipline of shrinking that loss distribution before it shows up in incidents, compliance failures, or broken customer journeys. The ROI on evals is not benchmarks 鈥?it is avoided production incidents at scale. If a single agent failure in a high-stakes financial or legal workflow costs more than the entire monthly productivity gain, the expected value of deployment is negative until the tail is controlled. That framing is now routine in risk-aware enterprise AI adoption, and it explains why evaluation tooling is no longer a niche product category.",
          "The regulatory and compliance dimension adds urgency. The EU AI Act's high-risk provisions require documented testing, ongoing monitoring, and audit trails for AI systems in consequential domains. In the United States, sector regulators 鈥?including the OCC and SEC 鈥?are publishing guidance that implies evaluable, documented AI behaviour as a condition of supervised deployment. Enterprises can no longer treat agent behaviour as a best-effort property. They need records of what was tested, what failed, how it was fixed, and who approved the deployment 鈥?and that documentation must survive an examination. Promptfoo's structured reporting output is a direct input into that compliance workflow.",
          "The deeper implication is competitive. Platform providers that can make testing native to the build cycle will be better positioned than those that leave safety and oversight to external wrappers. Enterprises do not merely want capable agents. They want agents whose behaviour can be inspected, challenged, and defended 鈥?to a compliance team, a regulator, or a customer who received an incorrect output. OpenAI's move effectively embeds evaluation infrastructure inside its developer toolchain, making it harder for enterprises to justify using a separate foundation model provider when the testing and governance tools are already integrated into the platform they are building on.",
          "For practitioners in energy modelling and quantitative research 鈥?domains where model outputs feed directly into financial and operational decisions 鈥?the evals framing is already familiar. Backtesting, stress-testing, and out-of-sample validation are the analogue of red-teaming in quantitative work. The distinction is that quantitative models are typically applied to well-defined tasks with clear ground truth, whereas LLM agents operate in open-ended task spaces where failure modes are harder to enumerate in advance. That gap is what red-teaming libraries exist to partially close 鈥?by adversarially probing the system before it encounters novel inputs in production.",
          "The broader pattern is one of industrial maturation. Every technology that has moved from innovation to regulated production has eventually acquired a testing and certification infrastructure: aviation has airworthiness standards, pharmaceuticals have clinical trial protocols, financial models have model risk management frameworks. AI agents are arriving at the same inflection point. OpenAI's acquisition of Promptfoo is not merely a product decision 鈥?it is a bet that the evaluation layer will become a mandatory cost of doing business, and that the company which owns the best tooling for it will have a structural advantage in enterprise accounts where compliance is non-negotiable.",
        ],
        modelView:
          "Agent ROI is not driven by mean output alone 鈥?it depends on the full loss distribution. Evaluation and red-teaming are attempts to reduce tail risk so that expected value remains positive in production at scale.",
        bottomLine:
          "The next phase of the AI platform race is about failure containment as much as capability 鈥?and OpenAI just bought the leading tool for it.",
        packet: {
          audience: defaultAudience,
          briefing:
            "Write a 1200鈥?400 word article on OpenAI's Promptfoo acquisition as a signal of enterprise AI maturity. Focus on evaluation, red-teaming, governance, and tail-risk management. Include one quantitative explanation of why production AI requires loss-distribution thinking, not just benchmark gains.",
    ...
    stories: [
      ...
      },
      {
        ...
        packet: {
          ...
          sourceAnchors: [
            {
              label: "IEEFA 鈥?data centre growth spurs PJM capacity prices tenfold",
              url: "https://ieefa.org/resources/projected-data-center-growth-spurs-pjm-capacity-prices-factor-10",
            },
            {
              label: "Utility Dive 鈥?data centres drove 40% of PJM capacity costs",
              url: "https://www.utilitydive.com/news/data-centers-pjm-capacity-auction/808951/",
            },
            {
              label: "Canary Media 鈥?PJM record capacity costs and rising bills",
      ...
      },
      {
        ...
        date: "April 3, 2026",
        headline:
          "Tech companies are building a shadow grid 鈥?and 30% of data centre power may soon be off-grid",
        dek:
        ...
        imageClassName: "object-center",
        paragraphs: [
          "The regulated electricity grid was designed around a simple topology: centralised generation, transmission across long distances, and distribution to a dispersed population of end users. What it was not designed for is a class of industrial users large enough to require the equivalent of a small city's power supply in a single location, growing fast enough to outpace any utility planning cycle. The response from those users has been to stop waiting for the grid and start building their own. This is not a workaround or a temporary measure 鈥?it is an architectural shift in how the most capital-intensive technology infrastructure in history is being powered, and it is happening across every major hyperscaler simultaneously.",
          "Chevron is working on a deal to build a dedicated natural gas plant for a Microsoft data centre in Texas. Amazon secured 1.5 gigawatts of dedicated solar capacity in the same state. According to a February 2026 report by Cleanview, a market intelligence firm, roughly 30% of all planned data centre power capacity is now expected to be on-site 鈥?up from almost nothing a year earlier. Forty-six data centre projects with a combined planned capacity of 56 GW are pursuing dedicated generation infrastructure outright. Microsoft's agreement with Constellation Energy to restart the Three Mile Island Unit 1 nuclear reactor is the most prominent example of a broader pattern: when grid power is too expensive, too slow to contract, or too unreliable in capacity-constrained regions, hyperscalers are moving directly to the supply side.",
          "Nuclear power purchase agreements have emerged as the premium end of the dedicated generation market. The economics are straightforward: nuclear plants provide 24/7 baseload power with no fuel-cost exposure and near-zero carbon emissions, making them ideal for data centres with sustainability commitments and reliability requirements. Google's agreement with Kairos Power for six to seven small modular reactors, Amazon's investment in X-energy, and several other hyperscaler nuclear PPA announcements in 2025鈥?026 collectively represent a revival of commercial nuclear power demand that the existing fleet of large reactors 鈥?most of them built before 1990 鈥?cannot fully satisfy. The result is a private-sector nuclear construction market developing in parallel to, and largely independent of, the public policy debates about nuclear subsidy and regulation.",
          "This divergence 鈥?between AI infrastructure that is increasingly self-powered and everything else that depends on the regulated grid 鈥?has material consequences for both electricity markets and for the ratepayers who remain on it. Dedicated generation removes high-volume, technically predictable load from the grid's demand base, which would normally reduce capacity market costs. The complication is that it does not reduce the fixed infrastructure costs of the grid itself 鈥?transmission lines, substations, distribution networks 鈥?which were built to serve a certain total load and must still be maintained regardless of how much of that load migrates off-grid. Those fixed costs are then allocated over a smaller remaining customer base, implying rising per-unit costs for residential customers and small businesses who have no alternative.",
          "The energy island model also creates a new category of infrastructure investment. Developers who can originate, finance, and build dedicated generation assets at data centre scale 鈥?whether gas, nuclear, or large-scale solar with storage 鈥?are operating in a market that did not meaningfully exist three years ago. The project economics are structurally attractive: long-dated offtake at contracted prices from creditworthy counterparties, with demand visibility that is orders of magnitude better than merchant generation. The critical bottleneck is not capital 鈥?there is significant institutional interest in infrastructure assets with technology-company counterparties 鈥?but execution: the engineering, permitting, and interconnection work required to deliver firm power to a specific site at a specific date is resource-constrained in ways that capital alone cannot solve.",
          "The permitting and regulatory dimension is underappreciated. Dedicated generation that operates behind the meter 鈥?physically connected to a data centre without flowing through the public grid 鈥?faces a different regulatory framework than grid-connected generation in most U.S. jurisdictions. State utility commissions, FERC, and in some cases the Nuclear Regulatory Commission all have jurisdictional interests depending on the technology and configuration. Some states are moving to streamline permitting for data centre power agreements; others are resisting, viewing the shadow grid as a threat to their integrated resource planning authority. The regulatory patchwork is one reason that Texas 鈥?with its deregulated ERCOT market and lighter state oversight of merchant generation 鈥?has attracted a disproportionate share of early dedicated generation deals.",
          "For energy modellers and power market practitioners, the shadow grid is already a significant modelling variable. The traditional assumption that data centre demand flows through the regulated grid is becoming incorrect at scale. Understanding the fraction of AI load that is off-grid, and how that changes marginal pricing, capacity market clearing, and transmission utilisation, is now a first-order input into any serious power market analysis. A model that assumes full grid dependency for AI load will overestimate forward demand on regulated networks and underestimate the rate at which fixed cost socialisation pressures accumulate for remaining grid customers 鈥?both errors with significant consequence for utility valuation, capacity investment decisions, and regulatory rate cases.",
        ],
        modelView:
          "Grid demand D_grid(t) = total AI load L_AI(t) 脳 (1 鈭?shadow grid fraction f(t)). As f(t) approaches 30%, the capacity market clearing and transmission utilisation models that assume full grid dependency produce systematically biased forecasts.",
        bottomLine:
          "The shadow grid is not a future scenario 鈥?it is already changing the economics of the regulated grid for everyone who remains connected to it.",
        packet: {
          audience: defaultAudience,
          briefing:
            "Write a 1400鈥?600 word analysis of the AI energy island phenomenon 鈥?dedicated off-grid power for data centres 鈥?and its consequences for regulated electricity markets. Cover the Chevron/Microsoft deal, the 30% off-grid projection, and explain the implications for capacity markets, ratepayer cross-subsidisation, and the investment opportunity in dedicated generation. Include one model showing how the shadow grid fraction affects regulated grid economics.",
          ...
          sourceAnchors: [
            {
              label: "Axios 鈥?AI power boom drives clash between grid and energy islands",
              url: "https://www.axios.com/2026/04/03/ai-power-data-centers-energy-grid",
            },
            {
              label: "Morgan Stanley 鈥?powering AI energy market outlook",
      ...
      },
      {
        ...
        dek:
          "With U.S. gas prices above $4 and crude back above $100, the market is treating energy as a regime variable again 鈥?not a sector detail.",
        image:
        ...
        packet: {
          audience: defaultAudience,
          briefing:
            "Write a 1300鈥?500 word markets article on why oil above $100 and gas above $4 change portfolio math. Explain the supply-shock transmission into inflation, sector margins, and stock-bond correlation. Include one compact mathematical explanation of persistence and pass-through.",
          ...
          sourceAnchors: [
            {
              label: "AP 鈥?U.S. gas prices above $4 and crude above $100",
