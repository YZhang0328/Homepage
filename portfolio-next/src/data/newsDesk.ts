  ...
  // ── Markets & Power ───────────────────────────────────────────────────────
  {
    ...
    stories: [
      ...
      },
      {
        ...
        imageClassName: "object-center",
        paragraphs: [
          "Capacity markets exist to ensure there is enough generation available to meet peak demand — and to price the cost of that adequacy into the electricity system. What they are not designed to absorb is a single new demand category growing fast enough to reprice the entire market. That is what AI data centres have done to PJM Interconnection, the largest grid operator in the United States, covering 13 states and the District of Columbia and serving roughly 65 million people. The design assumption embedded in capacity market auction mechanics is a world of gradually shifting load, where demand changes are measurable in fractions of a percentage point per year. Data centre demand growth is operating on a completely different curve.",
          "Capacity prices in PJM rose from $28.92 per megawatt-day in the 2024/25 delivery year to $329.17/MW-day in 2026/27 — roughly a tenfold increase in two years. The independent market monitor for PJM estimated that data centres were responsible for 63% of the price increase in the 2025/2026 auction, translating to $9.3 billion in costs to be recovered from customers across the PJM region through higher electric rates. In the December 2026 capacity auction, data centre load accounted for $6.5 billion, or 40%, of the total $16.4 billion in auction costs. These are not marginal adjustments — they represent a repricing of the fundamental scarcity value of generation capacity across the entire PJM footprint, driven almost entirely by a single demand category that did not feature meaningfully in any utility capacity forecast published before 2023.",
          "The transmission to retail bills is direct. Washington D.C. Pepco residential customers saw average monthly bills rise by $21 starting in June 2025, with roughly half of that increase attributable to the capacity price spike. PJM projects peak demand will grow by 32 gigawatts from 2024 to 2030 — with all but 2 gigawatts of that growth coming from data centres. The grid infrastructure that serves households and small businesses is being repriced by AI infrastructure investment at a rate that was not anticipated in any utility planning model. The distributional consequence is a direct transfer of cost from large technology companies — which own or operate the data centres creating the demand — to residential customers who have no mechanism to hedge, substitute, or opt out of the grid.",
          "The generation investment response is underway but structurally lagged. New dispatchable capacity — gas peakers, combined-cycle gas turbines, and the first wave of post-Vogtle nuclear additions — takes three to seven years from decision to commissioning. PJM's interconnection queue contains over 300 gigawatts of projects, of which a large fraction are solar and storage with lower firm capacity values during peak periods. The gap between what the grid needs to clear capacity markets at manageable prices and what can realistically be built in the planning window creates sustained upward pressure on capacity prices through at least the early 2030s. Utilities that own existing dispatchable generation — and that secured capacity obligations before the repricing — are sitting on assets whose value has appreciated dramatically and non-transparently.",
          "The market structure question this raises is acute. Capacity markets socialise the cost of grid adequacy across all ratepayers. When the incremental demand is almost entirely from large industrial users — data centres with dedicated substations and contracted capacity — the mechanism by which costs are distributed may need to change. Virginia has already created a new data centre electricity rate class in response. The policy debate about whether AI infrastructure should bear a larger share of capacity costs directly is accelerating, with proposals ranging from data-centre-specific capacity charges to direct procurement obligations that would require hyperscalers to sponsor the construction of new firm generation as a condition of grid interconnection. How that debate resolves will determine whether the current cost socialisation continues or is partially unwound.",
          "The interconnection queue dynamics compound the supply problem. Projects in PJM's queue face average wait times of over four years from application to commercial operation, and a significant fraction withdraw before completing the process — often because the transmission upgrade costs allocated during the study process make the project uneconomic. The Federal Energy Regulatory Commission's Order 2023 aims to reform these processes, but implementation is slow and contested. The practical result is that the generation investment needed to serve AI load faces both a capital deployment challenge and a permitting and interconnection bottleneck that no single policy actor controls.",
          "For energy market participants, the tenfold capacity price move in two years is a structural signal, not a cyclical one. PJM's demand growth forecast through 2030 is essentially a data centre forecast. The investors, utilities, and power generators that have positioned for sustained elevated capacity prices — and for the new generation assets needed to serve incremental AI load — are sitting on a structurally different set of forward exposures than those who treat this as a temporary distortion. The analytical work of separating cyclical from structural demand in power markets — always difficult — has become more important and more complex precisely because the structural driver is an industry where growth forecasts carry unusually high uncertainty.",
        ],
        modelView:
