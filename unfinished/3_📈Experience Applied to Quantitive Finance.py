...
with st.container():
    ...
    with text_column:
        st.markdown(
            '<p style="font-size: 18px; line-height: 1.75;">Modern trading and asset allocation increasingly rely on scientific and quantitative methodologies, rather than traditional experience-based approaches.</p>',
            unsafe_allow_html=True
        )

        st.markdown(
            '<p style="font-size: 18px; line-height: 1.75;">In trading and asset allocation, data-driven forecasting and mathematical formulation are pivotal. These offer a structured and efficient way to predict price trends, assist decision-making, optimize portfolios, and manage risks while adhering to regulatory requirements.</p>',
            unsafe_allow_html=True
        )

        st.markdown(
            '<p style="font-size: 18px; line-height: 1.75;">Developing effective investment strategies requires analyzing financial data, making predictions, and formulating optimization problems to balance competing objectives—maximizing returns and minimizing risk within specified constraints.</p>',
            unsafe_allow_html=True
        )

        st.markdown(
            '<p style="font-size: 18px; line-height: 1.75;">I specialize in two critical areas essential to successful financial decision-making:</p>',
            unsafe_allow_html=True
        )

        st.markdown(
            '<p style="font-size: 18px; line-height: 1.75;"><b>1. Financial data analysis and preparation:</b></p>',
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            '<p style="font-size: 18px; line-height: 1.75;"><b>2. Price forecasting and mathematical optimization for financial decisions:</b></p>',
            unsafe_allow_html=True
        )
